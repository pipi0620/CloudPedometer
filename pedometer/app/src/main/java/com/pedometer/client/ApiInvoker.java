...
import com.pedometer.client.auth.Authentication;
import com.pedometer.client.auth.ApiKeyAuth;
import com.pedometer.client.auth.HttpBasicAuth;
import com.pedometer.client.request.GetRequest;
import com.pedometer.client.request.PostRequest;
import com.pedometer.client.request.PutRequest;
import com.pedometer.client.request.DeleteRequest;
import com.pedometer.client.request.PatchRequest;

public class ApiInvoker {
    private static ApiInvoker INSTANCE;
    public static Map<String, String> defaultHeaderMap = new HashMap<String, String>();
    ...
    */
    ...
    public static void initializeInstance(Cache cache) {
        initializeInstance(cache, null, 0, null, 60);
    }
    ...
    public Request<String> createRequest(String host, String path, String method, List<Pair> queryParams, Object body, Map<String, String> headerParams, Map<String, String> formParams, String contentType, String[] authNames, Response.Listener<String> stringRequest, Response.ErrorListener errorListener) throws ApiException, UnsupportedEncodingException {
        ...
        if ("GET".equals(method)) {
            ...
            if (formParamStr != null) {
                request = new PostRequest(url, headers, contentType, new JsonEntity(serialize(body)), stringRequest, errorListener);
            } else if (body != null) {
                if (body instanceof HttpEntity) {
                    request = new PostRequest(url, headers, null, (HttpEntity) body, stringRequest, errorListener);
                } else {
                    request = new PostRequest(url, headers, null, new JsonEntity(serialize(body)), stringRequest, errorListener);
                }
            } else {
            ...
            request = null;
            if (formParamStr != null) {
                request = new PutRequest(url, headers, contentType, new JsonEntity(serialize(body)), stringRequest, errorListener);
            } else if (body != null) {
                if (body instanceof HttpEntity) {
                    request = new PutRequest(url, headers, null, (HttpEntity) body, stringRequest, errorListener);
                } else {
                    request = new PutRequest(url, headers, null, new JsonEntity(serialize(body)), stringRequest, errorListener);
                }
            } else {
            ...
            request = null;
            if (formParamStr != null) {
                request = new DeleteRequest(url, headers, contentType, new JsonEntity(serialize(body)), stringRequest, errorListener);
            } else if (body != null) {
                if (body instanceof HttpEntity) {
                    request = new DeleteRequest(url, headers, null, (HttpEntity) body, stringRequest, errorListener);
                } else {
                    request = new DeleteRequest(url, headers, null, new JsonEntity(serialize(body)), stringRequest, errorListener);
                }
            } else {
            ...
            request = null;
            if (formParamStr != null) {
                request = new PatchRequest(url, headers, contentType, new JsonEntity(serialize(body)), stringRequest, errorListener);
            } else if (body != null) {
                if (body instanceof HttpEntity) {
                    request = new PatchRequest(url, headers, null, (HttpEntity) body, stringRequest, errorListener);
                } else {
                    request = new PatchRequest(url, headers, null, new JsonEntity(serialize(body)), stringRequest, errorListener);
                }
            } else {
                request = new PatchRequest(url, headers, contentType, null, stringRequest, errorListener);
            }
        }
...
class JsonEntity extends StringEntity {
    ...
    public JsonEntity(String string) throws UnsupportedCharsetException,UnsupportedEncodingException {
        super(string, "UTF-8");
